...
$( document ).ready(function() {
    $('#searchbtn').click(function(){
        ...
        $.post('art_search.php', {keyword:_str, type:_type}, function(data){
            if (data == 'no') {
            ...
            $.each(data, function(){
                ...
                cell4.appendChild(addSpan(this.type));
            });
//            var _table = document.getElementById("preTable").tBodies[0];
        });
        ...
        <div class="col-md-3">
            <form action="#" method="get">
                ...
                <select class="selectpicker" id="type">
                      <option value="pixnet">pixnet</option>
                      <option value="youtube">youtube</option>
                      <option value="ptt_makeup">ptt</option>
                  </select>
